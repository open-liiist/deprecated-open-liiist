// auth-service/src/services/jwt.ts

import environment from '../config/environment';
import { ApiError } from '../utils/apiError';
import prisma from './prisma'; // Assicurati che prisma sia correttamente esportato
...
export async function saveRefreshToken(userId: string, refreshToken: string) {
    ...
    expiryDate.setDate(expiryDate.getDate() + 7); // Imposta la data di scadenza
