...
from libft import to_float, create_store, get_html_from_url, has_phone_number, has_superficie, geocodeurl, has_phone_number, has_superficie, geocode
# from send_data import create_store

def scraping_shop():
	generic_url = "https://www.cedigros.com/insegne/itemlist/filter.html?category=45&moduleId=219&Itemid=701&f63b37307b7737ac4a3515d3d0455523=1&format=raw"
	headers = {"Accept": "*/*"}
