...
def scraping_shop():
	generic_url = "https://www.cedigros.com/insegne/itemlist/filter.html?category=30&moduleId=219&Itemid=701&f63b37307b7737ac4a3515d3d0455523=1&format=raw"
	headers = {"Accept": "*/*"}
	...
	# with open(f"store_dem.json", "w", encoding="utf-8") as outfile:
